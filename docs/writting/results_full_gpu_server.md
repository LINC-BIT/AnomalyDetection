# Complete Benchmark Results — Full Machine
...
Platform: 2 × Intel Xeon Gold 6430 (128 threads), 256 GB, NVIDIA A100 80 GB, CUDA 12.4, fp32.
Dataset: [ZJU-Leaper](../../README.md#32-supported-datasets), `test` split, All textures, Full-shot, input 640 × 640.
...
| Model | Pixel AUROC | Pixel PRO | Pixel F1 | Pixel IoU | Mask AP50 | Mask AP |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
Segmentation models (DeepLabV3+, Mask R-CNN, UNet++) report masks directly, so Pixel AUROC/PRO/F1 are not measured for them; anomaly models have no mask AP. Both are correct under README §3.3.2. `Pixel PRO` is the same metric the Small Machine results call `Pixel AUPRO`.
...
| Model | AP | AP50 | AP75 | APs | APm | APl | AR@1 | AR@10 | AR@100 | ARs | ARm | ARl | P @0.25 | R @0.25 | F1 @0.25 | TP | FP | FN |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| Cascade R-CNN | 0.3333 | 0.6428 | 0.3042 | 0.0103 | 0.2175 | 0.5009 | 0.2808 | 0.4478 | 0.4703 | 0.1286 | 0.3618 | 0.6269 | 0.6327 | 0.6813 | 0.6561 | 124 | 72 | 58 |
| DETR | 0.0011 | 0.0022 | 0.0001 | 0.0000 | 0.0000 | 0.0021 | 0.0148 | 0.0159 | 0.0165 | 0.0000 | 0.0000 | 0.0323 | 0.0000 | 0.0000 | 0.0000 | — | — | 182 |
| Faster R-CNN | 0.3321 | 0.6623 | 0.3014 | 0.0339 | 0.2216 | 0.4758 | 0.2736 | 0.4489 | 0.4549 | 0.1000 | 0.3632 | 0.6022 | 0.5502 | 0.6923 | 0.6131 | 126 | 103 | 56 |
| YOLO11n | 0.2846 | 0.5754 | 0.2583 | 0.0453 | 0.1694 | 0.4272 | 0.2357 | 0.4357 | 0.5385 | 0.1476 | 0.5132 | 0.6452 | 0.9091 | 0.3297 | 0.4839 | 60 | 6 | 122 |
| YOLOv8n | 0.2721 | 0.5861 | 0.2130 | 0.0245 | 0.1505 | 0.4131 | 0.2181 | 0.4280 | 0.5269 | 0.0810 | 0.5059 | 0.6430 | 0.8571 | 0.3626 | 0.5097 | 66 | 11 | 116 |
| YOLOv8s | 0.2512 | 0.5380 | 0.1866 | 0.0481 | 0.1443 | 0.3852 | 0.2099 | 0.4154 | 0.5198 | 0.0619 | 0.4971 | 0.6398 | 0.9286 | 0.2143 | 0.3482 | 39 | 3 | 143 |
...
| Model | FPS (mean) | FPS (p95) | FPS (std) | FPS (CV) | Latency mean | Latency std | Latency CV | Latency p50 | Latency p95 | Latency p99 | FLOPs (G) | Wall-time |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| Cascade R-CNN | 0.82 | — | — | — | 1222.08 ms | — | — | 1223.76 ms | 1444.89 ms | 1444.89 ms | 408.0209 | 44.4 s |
| DETR | 56.58 | 56.72 | 2.7540 | 0.0485 | 17.67 ms | 0.88 ms | 0.0500 | 17.27 ms | 19.12 ms | 19.18 ms | 186.0145 | 46.0 s |
| DeepLabV3+ | 80.34 | 88.04 | 14.8480 | 0.1686 | 12.45 ms | 6.52 ms | 0.5237 | 10.80 ms | 11.66 ms | 40.82 ms | 572.1205 | 66.4 s |
| Dinomaly | 29.74 | — | — | — | 33.63 ms | — | — | 30.01 ms | 63.34 ms | 63.34 ms | 273.0566 | 37.4 s |
| EfficientAD | 3.72 | 3.85 | 0.7930 | 0.2062 | 268.96 ms | 45.23 ms | 0.1682 | 277.75 ms | 324.86 ms | 354.60 ms | 75.9065 | 60.7 s |
| Faster R-CNN | 60.42 | 60.67 | 3.7450 | 0.0617 | 16.55 ms | 1.11 ms | 0.0670 | 16.06 ms | 18.27 ms | 19.72 ms | 268.9822 | 21.6 s |
| GANomaly | 34.85 | 34.92 | 1.4300 | 0.0410 | 28.69 ms | 1.30 ms | 0.0454 | 28.32 ms | 30.37 ms | 33.46 ms | 33.0444 | 51.4 s |
| Mask R-CNN | 59.08 | 59.35 | 4.0270 | 0.0679 | 16.93 ms | 1.14 ms | 0.0671 | 17.61 ms | 18.46 ms | 18.75 ms | 277.0023 | 512.4 s |
| MoECLIP | 5.02 | — | — | — | 199.15 ms | — | — | 211.75 ms | 221.62 ms | 221.62 ms | 2241.5497 | 131.4 s |
| PaDiM | 77.32 | 77.41 | 2.6120 | 0.0337 | 12.93 ms | 0.44 ms | 0.0340 | 12.96 ms | 13.51 ms | 13.82 ms | 3.6884 | 43.3 s |
| PatchCore | 4.42 | 4.54 | 0.8040 | 0.1770 | 226.31 ms | 36.83 ms | 0.1627 | 227.70 ms | 309.07 ms | 312.48 ms | 24.1408 | 88.3 s |
| Reverse Distillation | 7.90 | 10.51 | 5.7150 | 0.5435 | 126.64 ms | 61.96 ms | 0.4893 | 145.05 ms | 215.47 ms | 266.32 ms | 67.8974 | 63.3 s |
| STFPM | 74.77 | 81.69 | 23.1850 | 0.2838 | 13.37 ms | 4.21 ms | 0.3145 | 13.56 ms | 21.89 ms | 24.02 ms | 7.3767 | 88.5 s |
| SuperSimpleNet | 17.38 | 17.44 | 0.9080 | 0.0521 | 57.53 ms | 3.49 ms | 0.0606 | 56.90 ms | 61.21 ms | 71.03 ms | 96.7028 | 93.0 s |
| UNet++ | 79.54 | 90.78 | 26.6720 | 0.2938 | 12.57 ms | 5.63 ms | 0.4475 | 10.22 ms | 19.50 ms | 30.95 ms | 250.2320 | 68.4 s |
| WinCLIP | 1.00 | — | — | — | 1004.65 ms | — | — | 1015.57 ms | 1080.09 ms | 1080.09 ms | 446.7010 | 590.6 s |
| YOLO11n | 308.48 | 310.60 | 27.0480 | 0.0871 | 3.24 ms | 0.25 ms | 0.0784 | 3.36 ms | 3.45 ms | 3.47 ms | 6.4406 | 11.9 s |
| YOLOv8n | 432.21 | 437.37 | 47.5070 | 0.1086 | 2.31 ms | 0.25 ms | 0.1088 | 2.49 ms | 2.64 ms | 2.68 ms | 14.9008 | 11.4 s |
| YOLOv8s | 355.33 | 355.92 | 13.9300 | 0.0391 | 2.81 ms | 0.12 ms | 0.0424 | 2.79 ms | 2.95 ms | 3.24 ms | 6.9886 | 11.9 s |

</div>

<br>

`LMEI`, `Max streams @budget`, `1-stream latency` and `resolution slope` were not produced (resolution sweep disabled).
...
| :---: | :---: | :---: | :---: | :---: | :---: |
| Cascade R-CNN | 69.1641 | 2281.1 | 2265.3 | 526.94 | process_rss |
| DETR | 44.3878 | 690.0 | 690.0 | 329.89 | device_allocator |
| DeepLabV3+ | 40.3470 | 603.9 | 603.9 | 308.18 | device_allocator |
| Dinomaly | 148.0090 | 1755.4 | 1755.4 | 564.71 | process_rss |
...
| Mask R-CNN | 43.9755 | 608.9 | 608.9 | 334.76 | device_allocator |
| MoECLIP | 433.5619 | 3538.5 | 3538.4 | 18.35 | process_rss |
| PaDiM | 2.7828 | 2247.4 | 2247.4 | 168.49 | process_rss |
| PatchCore | 24.8625 | 4505.1 | 4505.0 | 455.11 | process_rss |
| Reverse Distillation | 89.0023 | 3004.1 | 3004.1 | 765.57 | process_rss |
...
| WinCLIP | 208.3773 | 4254.8 | 4248.6 | 0.00 | process_rss |
...
`process_rss` (whole-process RSS, Anomalib backend) and `device_allocator` (torch CUDA allocator, torchvision/YOLO backend) are not directly comparable; the Small Machine results report whole-process RSS only.
...
| 10 | `Pixel AUPRO` → `Pixel PRO` | Same metric, README name is `Pixel PRO`. |
